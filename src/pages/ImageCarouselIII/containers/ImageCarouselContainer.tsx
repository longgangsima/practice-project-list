...
export default function ImageCarousel({
  ...
  const { exitClassname, enterClassname } =
    nextIndex != null && shouldTransitionToLeftDirection(currIndex, nextIndex, images.length)
      ? {
  ...
  return (
    <div className="image-carousel">
      <img
        ...
        src={currImage.src}
        key={currImage.src}
        className={clsx('image-carousel__image', isTransitioning && exitClassname)}
      />
      {nextImage != null && (
        <img
          alt={nextImage.alt}
          ...
          className={clsx('image-carousel__image', !isTransitioning && enterClassname)}
        />
      )}
      <button
